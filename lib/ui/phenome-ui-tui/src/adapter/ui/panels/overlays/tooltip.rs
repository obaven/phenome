...
/// use phenome_ui_tui::panels::render_tooltip;
///
/// # fn app() -> App { todo!() }
...
fn render_tooltip_box(frame: &mut Frame, area: Rect, lines: Vec<Line<'_>>) {
...
fn tooltip_lines(tooltip: &crate::state::Tooltip) -> Vec<Line<'_>> {
